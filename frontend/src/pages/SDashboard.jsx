...
//             // format scheduled time and total time
//             const scheduledTime = e.scheduleTime;             // e.g. "14:30"
//             const totalTime     = `${e.duration} min`;        // assuming `duration` in minutes

//             return {
//               subj:        e.subjectName,
//               no:          e.examNo,
//               sem:         `${e.semester}${['st','nd','rd'][e.semester % 10 - 1] || 'th'}`,
...
//                   <DetailRow label="Scheduled Time:"  value={e.scheduledTime} />
//                   <DetailRow label="Total Time:"      value={e.totalTime} />
...
//                       <td className="p-3 [@media(min-width:846px)]:p-4">{e.scheduledTime}</td>
//                       <td className="p-3 [@media(min-width:846px)]:p-4">{e.totalTime}</td>
//                       <td className="p-3 [@media(min-width:846px)]:p-4">{e.status}</td>
//                     </tr>
//                   ))}
//                 </tbody>
//               </table>
...
//                 const time = e.scheduleTime;
//                 const dur  = `${e.duration} minutes`;

//                 return (
//                   <div
//                     key={i}
//                     onClick={() => navigate('/take-exam/test-page', { state: { exam: e } })}
...
//               Recent Results
//             </h2>
//             {/* …your existing recentResults code… */}
//             {/* Card view on ≤485px */}
//             <div className="space-y-4 [@media(min-width:486px)]:hidden">
//               {recentResults.map((e, i) => (
//                 <div
